...
Public Class AleartDA
    ...
    Public Function Selectアラート() As (DBResult, List(Of アラート))
        ...
        stbSql.Append("      , (CAST( (前日株価 - 移動平均5) AS REAL ) / 移動平均5)  AS 移動平均5乖離率  ")
        stbSql.Append("      , (CAST( (前日株価 - 移動平均25) AS REAL ) / 移動平均25)  AS 移動平均25乖離率  ")
        stbSql.Append("      , (CAST( (前日株価 - 移動平均75) AS REAL ) / 移動平均75)  AS 移動平均75乖離率  ")
        stbSql.Append("  FROM   ")
        stbSql.Append("       (   ")
        stbSql.Append("        SELECT   ")
        stbSql.Append("               証券コード  ")
