...
Public Class GoldenCrossDA
    ...
    Public Function Selectゴールデンクロス() As (DBResult, List(Of ゴールデンクロス))
        ...
        stbSql.Append("      AND  (移動平均75_5 > 移動平均25_5 ")
        ...
        stbSql.Append("      AND  (移動平均5_5 > 移動平均25_5 ")
        stbSql.Append("      AND 移動平均5_4 > 移動平均25_4 ")
        stbSql.Append("      AND 移動平均5_3 > 移動平均25_3 ")
        stbSql.Append("      AND 移動平均5_2 > 移動平均25_2 ")
        stbSql.Append("      AND 移動平均5_1 > 移動平均25_1 ")
        stbSql.Append("      AND 移動平均5   > 移動平均25 ) ")
        stbSql.Append("      AND  (移動平均75_5 <= 移動平均75_4 ")
        stbSql.Append("      AND 移動平均75_4 <= 移動平均75_3 ")
        stbSql.Append("      AND 移動平均75_3 <= 移動平均75_2 ")
        stbSql.Append("      AND 移動平均75_2 <= 移動平均75_1 ")
        stbSql.Append("      AND 移動平均75_1 <= 移動平均75 )")
